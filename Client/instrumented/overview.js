...
$((function () {
  ...
  _$jscoverage['overview.js'][52]++;
  var overview = (function () {
  _$jscoverage['overview.js'][53]++;
  var instances = {};
  _$jscoverage['overview.js'][54]++;
  var instancestable = $("#instancestable");
  _$jscoverage['overview.js'][55]++;
  var entryPrototype = $("<tr><td><a/></td><td/><td/><td/></tr>");
  _$jscoverage['overview.js'][56]++;
  function newInstance(data) {
    _$jscoverage['overview.js'][57]++;
    var that = {};
    _$jscoverage['overview.js'][58]++;
    var entry = entryPrototype.clone();
    _$jscoverage['overview.js'][59]++;
    var tds = entry.find("td");
    _$jscoverage['overview.js'][61]++;
    that.update = (function (data) {
  _$jscoverage['overview.js'][62]++;
  $(tds[0]).find("a").attr("href", (SINGLE_INSTANCE_LINK + data.id)).text(data.id);
  _$jscoverage['overview.js'][63]++;
  $(tds[1]).text(data.workflowName);
  _$jscoverage['overview.js'][64]++;
  $(tds[2]).html(prettyDateDiff(data.create));
  _$jscoverage['overview.js'][65]++;
  $(tds[3]).html((prettyEvent[data.lastEvent] + " " + prettyDateDiff(data.finished)));
  _$jscoverage['overview.js'][66]++;
  if ((data.lastEvent == "terminateInstance")) {
    _$jscoverage['overview.js'][67]++;
    entry.addClass("finished-instance");
  }
});
    _$jscoverage['overview.js'][70]++;
    entry.hide();
    _$jscoverage['overview.js'][71]++;
    instancestable.append(entry);
    _$jscoverage['overview.js'][72]++;
    that.update(data);
    _$jscoverage['overview.js'][73]++;
    entry.fadeIn();
    _$jscoverage['overview.js'][74]++;
    entry.css("display", "table-row");
    _$jscoverage['overview.js'][75]++;
    return that;
}
  _$jscoverage['overview.js'][78]++;
  return ({update: (function (data) {
  _$jscoverage['overview.js'][80]++;
  data.forEach((function (instancedata) {
  _$jscoverage['overview.js'][81]++;
  if ((! instances[instancedata.id])) {
    _$jscoverage['overview.js'][82]++;
    instances[instancedata.id] = newInstance(instancedata);
  }
  else {
    _$jscoverage['overview.js'][85]++;
    instances[instancedata.id].update(instancedata);
  }
}));
})});
})();
  _$jscoverage['overview.js'][92]++;
  var ajaxUpdater = (function () {
  _$jscoverage['overview.js'][104]++;
  return ({init: (function loop() {
  _$jscoverage['overview.js'][106]++;
  $.getJSON(POLL_URL, {}, (function (data) {
  _$jscoverage['overview.js'][107]++;
  overview.update(data);
}));
  _$jscoverage['overview.js'][109]++;
  setTimeout(loop, 5000);
  _$jscoverage['overview.js'][110]++;
  return this;
})});
})().init();
}));
